...
<div class="row" id="header_row">
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        <ul class="list-inline" id="left_header">
            <li><a href="{{ url('moderate') }}"><i style="font-size: 22px;" class="fa fa-home"></i></a></li>
    ...
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
        <ul class="list-inline" id="center">
            <li><span id="center_text"><a id="center_text" href="{{ url('moderate') }}">Admin - The Scoree</a></span></li>    
          </ul>
    </div>
          ...
          <li>
            ...
            <div id="target"></div> -->
              <!-- <div class="dropdown"> -->
                ...
                <span class="glyphicon glyphicon-th " style="font-size:18px;padding-right:10px;"></span>
                <a href="{{url('moderator/logout')}}"> <span class="fa fa-sign-out" style="font-size:22px;"></span></a>
